...
@Composable
private fun FutureHourTemperature(hoursAhead: Long, hourlyValues: com.sheltek.kmpweather.models.HourlyValues?) {
...
@Composable
fun CurrentWeatherDescription(dailyValues: com.sheltek.kmpweather.models.DailyValues?) {
    Text(
        text = when {
...
@Composable
fun DailyWeatherIcon(dailyValues: com.sheltek.kmpweather.models.DailyValues?) {
//    Image(
//        provider = when {
...
@Composable
fun HourlyWeatherIcon(hourlyValues: com.sheltek.kmpweather.models.HourlyValues?) {
//    Image(
//        provider = when {
...
data class ThreeHourForecastState(
    val currentHourlyValues: com.sheltek.kmpweather.models.HourlyValues? = null,
    val todayDailyValue: com.sheltek.kmpweather.models.DailyValues? = null,
    val futureHourlyValues1: com.sheltek.kmpweather.models.HourlyValues? = null,
    val futureHourlyValues2: com.sheltek.kmpweather.models.HourlyValues? = null,
    val futureHourlyValues3: com.sheltek.kmpweather.models.HourlyValues? = null,
)
