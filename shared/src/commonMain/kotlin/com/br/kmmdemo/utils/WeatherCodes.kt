...
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.DAY_CLOUDY
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.DAY_FOG
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.DAY_PARTLY_CLOUDY
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.DAY_RAIN
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.DAY_SNOW
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.DAY_THUNDERSTORM
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.HAIL
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.HEAVY_RAIN
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.LIGHT_RAIN
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.NIGHT_CLEAR
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.NIGHT_CLOUDY
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.NIGHT_FOG
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.NIGHT_RAIN
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.NIGHT_SNOW
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.NIGHT_THUNDERSTORM
import com.br.kmmdemo.compose.ui.forecasts.WeatherEnum.SUNNY
