package com.sheltek.kmpweather.compose.ui.weatherDetails.airQuality
...
import com.sheltek.kmpweather.compose.ui.weatherDetails.DETAILS_WIDGET_SIZE
...
fun AirQualityWidget(risk: AirQualityEnum = AirQualityEnum.UNKNOWN) {
    Surface(
        ...
        Column(
            ...
            KmpWeatherSlider(initValue = risk.level, valueRange = 0f..0.6f)
