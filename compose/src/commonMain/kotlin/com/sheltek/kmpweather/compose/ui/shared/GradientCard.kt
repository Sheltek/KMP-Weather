package com.sheltek.kmpweather.compose.ui.shared
...
import com.sheltek.kmpweather.compose.resources.theme.Gradients
import com.sheltek.kmpweather.compose.resources.theme.largeCardCorner
import com.sheltek.kmpweather.compose.ui.utils.SHEET_MAX_HEIGHT
import com.sheltek.kmpweather.compose.ui.utils.SHEET_MIN_HEIGHT
import com.sheltek.kmpweather.compose.ui.utils.gradientCardModifier
    ...
    OutlinedCard(
        ...
        border = BorderStroke(
            ...
            Brush.verticalGradient(
                colors = listOf(
                    com.sheltek.kmpweather.compose.resources.theme.outline.copy(alpha = if (isExpanded) 0f else 1f),
                    Color.Transparent,
                ),
                startY = 0f,
